    ...
    .then(function (response) {
        ...
        students.forEach(student => {
            ...
            row.innerHTML = `
                ...
                <td><a href="#"><img src="./images/cancel.png" title="Excluir Estudante" onclick="excluirEstudante(${student.idEstudante});"></a></td>
                <td><a href="#"><img src="./images/user.png" title="Alterar Estudante" onclick="alterarEstudante(${student.idEstudante});"></a></td>
            `;
...
function incluirEstudante() {
    ...
    .then(function (response) {
        messageElement.style.color = 'green';
        messageElement.textContent = 'Estudante incluído com sucesso!';
        ativaModal('Estudante incluído com sucesso! ' + response.data);
        document.getElementById('but-clear-form-estudante').click();
        console.log("Resposta cadastro estudante: " + response.data);
        setTimeout(function () {
            messageElement.textContent = '';
    ...
    .catch(function (error) {
        messageElement.style.color = 'red';
        messageElement.textContent = 'Erro ao incluir estudante.';
        ativaModal('Erro ao incluir estudante.');
        console.error(error);
    });
}

function ativaModal(message) {
    // Implementação da função para exibir um modal com a mensagem
    alert(message);
}

function ativaComp(componentId) {
    // Implementação da função para ativar/exibir um componente pelo ID
